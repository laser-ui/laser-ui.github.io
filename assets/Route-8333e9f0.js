...
${s}`),qt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:i},{openFile:"Demo.tsx"})}function es(e){const{id:t,renderer:s,title:i,description:o,tsxSource:a,scssSource:p}=e,m=F(q(o)),c=q(a),u=p?q(p):void 0,{t:h}=ye(),C=d.useRef(null),A=F(String.raw`
${"```tsx"}
${c}
${"```"}
`),T=u?F(String.raw`
