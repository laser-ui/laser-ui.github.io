import{r as d,u as Pe,a as Re,b as ze,y as Ne,l as U,c as Oe,J as He,h as Ue,k as fe,g as Be,j as n,m as Ve,I,N as Fe,s as We,L as qe,a0 as Ke,a1 as Ge,a2 as W,a3 as ye,a4 as Je,a5 as Ye,z as Z,a6 as we,a7 as je,a8 as ge}from"./index-db2d914b.js";import{d as q,M as Ze}from"./MdRoute-3f054aa5.js";import{S as Xe}from"./add-dd4b1309.js";function Qe(e){d.useEffect(()=>e(),[])}function et(e){if(navigator.clipboard)navigator.clipboard.writeText(e);else{let t=document.createElement("textarea");t.style.cssText="position:fixed;opacity:0;",t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),t=null}}const tt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M12 5.99 19.53 19H4.47L12 5.99M12 2 1 21h22L12 2zm1 14h-2v2h2v-2zm0-6h-2v4h2v-4z"})),st=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"})),nt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"})),it={tabs:"^tabs","tabs--wrap":"^tabs--wrap","tabs--slider":"^tabs--slider","tabs--top":"^tabs--top","tabs--right":"^tabs--right","tabs--bottom":"^tabs--bottom","tabs--left":"^tabs--left","tabs--small":"^tabs--small","tabs--medium":"^tabs--medium","tabs--large":"^tabs--large","tabs--center":"^tabs--center","tabs__tablist-wrapper":"^tabs__tablist-wrapper",tabs__tablist:"^tabs__tablist",tabs__tab:"^tabs__tab","tabs__tab.is-active":"is-active","tabs__tab.is-disabled":"is-disabled","tabs__tab--first":"^tabs__tab--first","tabs__tab--last":"^tabs__tab--last",tabs__close:"^tabs__close","tabs__button-container":"^tabs__button-container",tabs__button:"^tabs__button","tabs__button.is-end":"is-end","tabs__button--more":"^tabs__button--more","tabs__button--add":"^tabs__button--add",tabs__indicator:"^tabs__indicator","tabs__wrap-indicator":"^tabs__wrap-indicator","tabs__slider-indicator":"^tabs__slider-indicator",tabs__tabpanel:"^tabs__tabpanel"};function ot(e){const{ref:t,styleOverrides:s,styleProvider:i,list:o,active:a,defaultActive:p,pattern:m,placement:c="top",center:u=!1,size:h="medium",addible:C=!1,lazyLoading:M=!0,onActiveChange:T,onAddClick:D,onClose:L,..._}=Pe("Tabs",e),A=Re(),j=ze(it,{tabs:i==null?void 0:i.tabs},s),{t:O}=Ne(),se=d.useId(),P=r=>`${A}-tabs-tab-${r}-${se}`,K=r=>`${A}-tabs-panel-${r}-${se}`,G=d.useRef(null),H=d.useRef(null),l=d.useRef(null),E=d.useRef(null),B=d.useRef(null),[ue,Ie]=d.useState(!1),[Le,Te]=d.useState([]),[De,Ae]=d.useState(!1),me=h==="small"?16:h==="large"?20:18,V=c==="top"||c==="bottom",Me=d.useMemo(()=>{if(!U.isUndefined(p))return p;for(const r of o)if(!r.disabled)return r.id;return null},[]),[J,ne]=Oe(Me,a,r=>{T&&T(r,He(o,b=>b.id===r))}),Y=()=>{const r=H.current;if(r){const b=V?r.scrollWidth>r.clientWidth:r.scrollHeight>r.clientHeight;if(Ie(b),Ae(Ke(r)[V?"x":"y"]),b){const x=r.getBoundingClientRect(),y=[];o.forEach(k=>{var R,z;const F=document.getElementById(P(k.id));if(F){const S=F.getBoundingClientRect();V?(S.right+(((R=E.current)==null?void 0:R.offsetWidth)??0)>x.right||S.left<x.left)&&y.push(k):(S.bottom+(((z=E.current)==null?void 0:z.offsetHeight)??0)>x.bottom||S.top<x.top)&&y.push(k)}}),Te(y)}}};Ue(()=>{Y()},[]),fe(H,Y),fe(l,Y);const ie=Be(()=>{if(l.current&&B.current){const r=l.current.getBoundingClientRect();for(const b of o)if(b.id===J){const x=document.getElementById(P(b.id));if(x){const y=x.getBoundingClientRect();V?B.current.style.cssText=`left:${y.left-r.left}px;width:${y.width}px;opacity:1;`:B.current.style.cssText=`top:${y.top-r.top}px;opacity:1;`}}}});return d.useEffect(()=>{ie()}),d.useImperativeHandle(t,()=>({updateIndicator:ie}),[ie]),n.jsxs("div",{..._,...Ve(j("tabs",`tabs--${c}`,`tabs--${h}`,{[`tabs--${m}`]:m,"tabs--center":u}),{className:_.className,style:_.style}),ref:r=>(G.current=r,()=>{G.current=null}),children:[n.jsx("div",{...j("tabs__tablist-wrapper"),ref:r=>(H.current=r,()=>{H.current=null}),onScroll:()=>{Y()},children:n.jsxs("div",{...j("tabs__tablist"),ref:r=>(l.current=r,()=>{l.current=null}),role:"tablist","aria-orientation":V?"horizontal":"vertical",children:[o.map((r,b)=>{const{id:x,title:y,disabled:k,closable:F}=r,R=x===J,z=(g,f=b)=>{for(let $=g?f+1:f-1,be=0;be<o.length;g?$++:$--,be++){const oe=U.nth(o,$%o.length);if(oe&&!oe.disabled)return oe}},S=g=>{if(g){ne(g.id);const f=document.getElementById(P(g.id));f&&f.focus()}},he=()=>{if(R){let g=!1;for(let f=b+1;f<o.length;f++){const $=U.nth(o,f);if($&&!$.disabled){g=!0,S($);break}}if(!g)for(let f=b-1;f>=0;f--){const $=U.nth(o,f);if($&&!$.disabled){S($);break}}}L==null||L(x,r)};return d.createElement("div",{...j("tabs__tab",{"tabs__tab.is-active":R,"tabs__tab.is-disabled":k,"tabs__tab--first":b===0,"tabs__tab--last":b===o.length-1}),key:x,id:P(x),tabIndex:R&&!k?0:-1,role:"tab","aria-controls":K(x),"aria-selected":R,"aria-disabled":k,onClick:()=>{ne(x)},onKeyDown:g=>{switch(g.code){case"Delete":g.preventDefault(),F&&he();break;case"ArrowLeft":g.preventDefault(),(c==="top"||c==="bottom")&&S(z(!1));break;case"ArrowRight":g.preventDefault(),(c==="top"||c==="bottom")&&S(z(!0));break;case"ArrowUp":g.preventDefault(),(c==="left"||c==="right")&&S(z(!1));break;case"ArrowDown":g.preventDefault(),(c==="left"||c==="right")&&S(z(!0));break;case"Home":g.preventDefault();for(const f of o)if(!f.disabled){S(f);break}break;case"End":g.preventDefault();for(let f=o.length-1;f>=0;f--)if(!o[f].disabled){S(o[f]);break}break}}},y,!k&&F&&n.jsx("div",{...j("tabs__close"),role:"button","aria-label":O("Close"),onClick:g=>{g.stopPropagation(),he()},children:n.jsx(I,{children:n.jsx(Fe,{})})}))}),(ue||C)&&n.jsxs("div",{...j("tabs__button-container"),ref:r=>(E.current=r,()=>{E.current=null}),children:[ue&&n.jsx(We,{list:Le.map(r=>{const{id:b,title:x,dropdownRender:y,disabled:k}=r;return{id:b,title:U.isUndefined(y)?x:y,type:"item",disabled:k,style:b===J?{color:`var(--${A}-color-primary)`}:void 0}}),placement:c==="left"?"bottom-left":"bottom-right",onClick:r=>{ne(r)},children:r=>n.jsx("div",{...j("tabs__button","tabs__button--more",{"tabs__button.is-end":De}),...r,"aria-label":O("More"),children:n.jsx(I,{size:me,children:n.jsx(st,{})})})}),C&&n.jsx("div",{...j("tabs__button","tabs__button--add"),role:"button","aria-label":O("Add"),onClick:()=>{D==null||D()},children:n.jsx(I,{size:me,children:n.jsx(Xe,{})})})]}),n.jsx("div",{...j(m==="wrap"?"tabs__wrap-indicator":m==="slider"?"tabs__slider-indicator":"tabs__indicator"),ref:r=>(B.current=r,()=>{B.current=null})})]})}),o.map(r=>{const{id:b,panel:x}=r,y=b!==J;return d.createElement("div",{...j("tabs__tabpanel"),key:b,id:K(b),tabIndex:0,hidden:y,role:"tabpanel","aria-labelledby":P(b)},n.jsx(qe,{hidden:y,disabled:!M,children:x}))})]})}const rt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"})),v={"index.html":`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
...
</html>`}function Ot(e,t){const s=ke(e);s.action=ae("/run",t),s.target=pe(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function te(e){return e!=null&&e.contentWindow?(Pt(e)??new Mt(e)).pending:Promise.reject("Provided element is not an iframe.")}function Ht(e,t){Ot(e,t)}function Ut(e,t){const s=ae(`/edit/${e}`,t),i=pe(t);window.open(s,i)}function Bt(e,t){const s=ae(`/github/${e}`,t),i=pe(t);window.open(s,i)}function Vt(e,t,s){var p;const i=de(e),o=Nt(t,s),a=document.createElement("iframe");return le(i,a,s),(p=a.contentDocument)==null||p.write(o),te(a)}function Ft(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/edit/${t}`,s),le(i,o,s),te(o)}function Wt(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/github/${t}`,s),le(i,o,s),te(o)}const qt={connect:te,embedGithubProject:Wt,embedProject:Vt,embedProjectId:Ft,openGithubProject:Bt,openProject:Ht,openProjectId:Ut};function Kt(e,t,s){const i={"index.html":v["index.html"],"src/App.tsx":v["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":v["src/main.tsx"],"src/styles/index.scss":v["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":v["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/laser-ui.scss":v["src/styles/vendor/laser-ui.scss"],"package.json":Se(e),"tsconfig.json":v["tsconfig.json"],"vite.config.ts":v["vite.config.ts"]};s&&(i["src/styles/index.scss"]=`${v["src/styles/index.scss"]}
${s}`),qt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:i},{openFile:"Demo.tsx"})}function es(e){const{id:t,renderer:s,title:i,description:o,tsxSource:a,scssSource:p}=e,m=W(q(o)),c=q(a),u=p?q(p):void 0,{t:h}=ye(),C=d.useRef(null),M=W(String.raw`
${"```tsx"}
${c}
${"```"}
`),T=u?W(String.raw`
