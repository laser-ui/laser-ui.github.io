import{r as d,u as Pe,a as Re,b as ze,v as Ne,l as U,c as He,G as Oe,g as Ue,i as fe,f as Be,j as n,m as We,I,K as Ve,o as Fe,L as qe,Z as Ke,_ as F,$ as ye,a0 as Ge,a1 as Je,x as Y,a2 as we,a3 as je,a4 as ge}from"./index-11f4945e.js";import{d as q,M as Ze}from"./MdRoute-cddf3ef6.js";import{S as Ye}from"./add-fdc20cbd.js";function Xe(e){d.useEffect(()=>e(),[])}function Qe(e){return{x:e.scrollWidth<=Math.ceil(e.scrollLeft)+e.clientWidth,y:e.scrollHeight<=Math.ceil(e.scrollTop)+e.clientHeight}}function et(e){if(navigator.clipboard)navigator.clipboard.writeText(e);else{let t=document.createElement("textarea");t.style.cssText="position:fixed;opacity:0;",t.value=e,document.body.appendChild(t),t.select(),document.execCommand("copy"),document.body.removeChild(t),t=null}}const tt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M12 5.99 19.53 19H4.47L12 5.99M12 2 1 21h22L12 2zm1 14h-2v2h2v-2zm0-6h-2v4h2v-4z"})),st=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M6 10c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm12 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm-6 0c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2z"})),nt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M9 16.17 4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41L9 16.17z"})),it={tabs:"^tabs","tabs--wrap":"^tabs--wrap","tabs--slider":"^tabs--slider","tabs--top":"^tabs--top","tabs--right":"^tabs--right","tabs--bottom":"^tabs--bottom","tabs--left":"^tabs--left","tabs--small":"^tabs--small","tabs--medium":"^tabs--medium","tabs--large":"^tabs--large","tabs--center":"^tabs--center","tabs__tablist-wrapper":"^tabs__tablist-wrapper",tabs__tablist:"^tabs__tablist",tabs__tab:"^tabs__tab","tabs__tab.is-active":"is-active","tabs__tab.is-disabled":"is-disabled","tabs__tab--first":"^tabs__tab--first","tabs__tab--last":"^tabs__tab--last",tabs__close:"^tabs__close","tabs__button-container":"^tabs__button-container",tabs__button:"^tabs__button","tabs__button.is-end":"is-end","tabs__button--more":"^tabs__button--more","tabs__button--add":"^tabs__button--add",tabs__indicator:"^tabs__indicator","tabs__wrap-indicator":"^tabs__wrap-indicator","tabs__slider-indicator":"^tabs__slider-indicator",tabs__tabpanel:"^tabs__tabpanel"};function ot(e){const{ref:t,styleOverrides:s,styleProvider:i,list:o,active:c,defaultActive:p,pattern:m,placement:a="top",center:u=!1,size:h="medium",addible:C=!1,lazyLoading:A=!0,onActiveChange:T,onAddClick:D,onClose:L,..._}=Pe("Tabs",e),M=Re(),w=ze(it,{tabs:i==null?void 0:i.tabs},s),{t:H}=Ne(),se=d.useId(),P=r=>`${M}-tabs-tab-${r}-${se}`,K=r=>`${M}-tabs-panel-${r}-${se}`,G=d.useRef(null),O=d.useRef(null),l=d.useRef(null),E=d.useRef(null),B=d.useRef(null),[ue,Ie]=d.useState(!1),[Le,Te]=d.useState([]),[De,Me]=d.useState(!1),me=h==="small"?16:h==="large"?20:18,W=a==="top"||a==="bottom",Ae=d.useMemo(()=>{if(!U.isUndefined(p))return p;for(const r of o)if(!r.disabled)return r.id;return null},[]),[J,ne]=He(Ae,c,r=>{T&&T(r,Oe(o,b=>b.id===r))}),Z=()=>{const r=O.current;if(r){const b=W?r.scrollWidth>r.clientWidth:r.scrollHeight>r.clientHeight;if(Ie(b),Me(Qe(r)[W?"x":"y"]),b){const x=r.getBoundingClientRect(),y=[];o.forEach(k=>{var R,z;const V=document.getElementById(P(k.id));if(V){const j=V.getBoundingClientRect();W?(j.right+(((R=E.current)==null?void 0:R.offsetWidth)??0)>x.right||j.left<x.left)&&y.push(k):(j.bottom+(((z=E.current)==null?void 0:z.offsetHeight)??0)>x.bottom||j.top<x.top)&&y.push(k)}}),Te(y)}}};Ue(()=>{Z()},[]),fe(O,Z),fe(l,Z);const ie=Be(()=>{if(l.current&&B.current){const r=l.current.getBoundingClientRect();for(const b of o)if(b.id===J){const x=document.getElementById(P(b.id));if(x){const y=x.getBoundingClientRect();W?B.current.style.cssText=`left:${y.left-r.left}px;width:${y.width}px;opacity:1;`:B.current.style.cssText=`top:${y.top-r.top}px;opacity:1;`}}}});return d.useEffect(()=>{ie()}),d.useImperativeHandle(t,()=>({updateIndicator:ie}),[ie]),n.jsxs("div",{..._,...We(w("tabs",`tabs--${a}`,`tabs--${h}`,{[`tabs--${m}`]:m,"tabs--center":u}),{className:_.className,style:_.style}),ref:r=>(G.current=r,()=>{G.current=null}),children:[n.jsx("div",{...w("tabs__tablist-wrapper"),ref:r=>(O.current=r,()=>{O.current=null}),onScroll:()=>{Z()},children:n.jsxs("div",{...w("tabs__tablist"),ref:r=>(l.current=r,()=>{l.current=null}),role:"tablist","aria-orientation":W?"horizontal":"vertical",children:[o.map((r,b)=>{const{id:x,title:y,disabled:k,closable:V}=r,R=x===J,z=(g,f=b)=>{for(let $=g?f+1:f-1,be=0;be<o.length;g?$++:$--,be++){const oe=U.nth(o,$%o.length);if(oe&&!oe.disabled)return oe}},j=g=>{if(g){ne(g.id);const f=document.getElementById(P(g.id));f&&f.focus()}},he=()=>{if(R){let g=!1;for(let f=b+1;f<o.length;f++){const $=U.nth(o,f);if($&&!$.disabled){g=!0,j($);break}}if(!g)for(let f=b-1;f>=0;f--){const $=U.nth(o,f);if($&&!$.disabled){j($);break}}}L==null||L(x,r)};return d.createElement("div",{...w("tabs__tab",{"tabs__tab.is-active":R,"tabs__tab.is-disabled":k,"tabs__tab--first":b===0,"tabs__tab--last":b===o.length-1}),key:x,id:P(x),tabIndex:R&&!k?0:-1,role:"tab","aria-controls":K(x),"aria-selected":R,"aria-disabled":k,onClick:()=>{ne(x)},onKeyDown:g=>{switch(g.code){case"Delete":g.preventDefault(),V&&he();break;case"ArrowLeft":g.preventDefault(),(a==="top"||a==="bottom")&&j(z(!1));break;case"ArrowRight":g.preventDefault(),(a==="top"||a==="bottom")&&j(z(!0));break;case"ArrowUp":g.preventDefault(),(a==="left"||a==="right")&&j(z(!1));break;case"ArrowDown":g.preventDefault(),(a==="left"||a==="right")&&j(z(!0));break;case"Home":g.preventDefault();for(const f of o)if(!f.disabled){j(f);break}break;case"End":g.preventDefault();for(let f=o.length-1;f>=0;f--)if(!o[f].disabled){j(o[f]);break}break}}},y,!k&&V&&n.jsx("div",{...w("tabs__close"),role:"button","aria-label":H("Close"),onClick:g=>{g.stopPropagation(),he()},children:n.jsx(I,{children:n.jsx(Ve,{})})}))}),(ue||C)&&n.jsxs("div",{...w("tabs__button-container"),ref:r=>(E.current=r,()=>{E.current=null}),children:[ue&&n.jsx(Fe,{list:Le.map(r=>{const{id:b,title:x,dropdownRender:y,disabled:k}=r;return{id:b,title:U.isUndefined(y)?x:y,type:"item",disabled:k,style:b===J?{color:`var(--${M}-color-primary)`}:void 0}}),placement:a==="left"?"bottom-left":"bottom-right",onClick:r=>{ne(r)},children:r=>n.jsx("div",{...w("tabs__button","tabs__button--more",{"tabs__button.is-end":De}),...r,"aria-label":H("More"),children:n.jsx(I,{size:me,children:n.jsx(st,{})})})}),C&&n.jsx("div",{...w("tabs__button","tabs__button--add"),role:"button","aria-label":H("Add"),onClick:()=>{D==null||D()},children:n.jsx(I,{size:me,children:n.jsx(Ye,{})})})]}),n.jsx("div",{...w(m==="wrap"?"tabs__wrap-indicator":m==="slider"?"tabs__slider-indicator":"tabs__indicator"),ref:r=>(B.current=r,()=>{B.current=null})})]})}),o.map(r=>{const{id:b,panel:x}=r,y=b!==J;return d.createElement("div",{...w("tabs__tabpanel"),key:b,id:K(b),tabIndex:0,hidden:y,role:"tabpanel","aria-labelledby":P(b)},n.jsx(qe,{hidden:y,disabled:!A,children:x}))})]})}const rt=e=>d.createElement("svg",{xmlns:"http://www.w3.org/2000/svg",width:24,height:24,viewBox:"0 0 24 24",...e},d.createElement("path",{d:"M16 1H4c-1.1 0-2 .9-2 2v14h2V3h12V1zm3 4H8c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h11c1.1 0 2-.9 2-2V7c0-1.1-.9-2-2-2zm0 16H8V7h11v14z"})),v={"index.html":`<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8" />
...
`,at="node_modules/lerna/schemas/lerna-schema.json",lt=["libs/components","libs/hooks","libs/utils","libs/themes"],dt="2.0.0",pt={version:{conventionalCommits:!0,message:"chore: release %v",createRelease:"github",forcePublish:!0,exact:!0},publish:{yes:!0}},X={$schema:at,packages:lt,version:dt,command:pt},ut="@laser-ui/source",mt="0.0.0",ht="MIT",bt={"build:affected":"nx affected -t build","lint:affected":"nx affected -t lint","lint:style":"stylelint **/*.{css,scss,html,md}",prepare:"husky install && ts-node -P ./tools/tsconfig.tools.json ./tools/scripts/husky.ts",prepublishOnly:"nx run-many -t build -p components hooks utils themes","test:affected":"nx affected -t test","util:prettier":"prettier . --write","util:sort-package-json":"sort-package-json 'package.json' 'libs/*/package.json'",version:"prettier lerna.json --write"},ft={"@laser-pro/storage":"^0.1.0","@material-design-icons/svg":"^0.14.12",axios:"^1.6.8",bootstrap:"^5.3.2",codesandbox:"^2.2.3",dayjs:"^1.11.9","highlight.js":"^11.8.0",i18next:"^23.5.1",immer:"^10.0.2",lodash:"^4.17.21",marked:"^6.0.0","marked-highlight":"^2.0.6","rcl-store":"^2.1.0",react:"^19.0.0","react-dom":"^19.0.0","react-i18next":"^13.2.2","react-router-dom":"^6.15.0",rfs:"^10.0.0",tslib:"^2.6.2"},gt={"@babel/core":"^7.22.17","@babel/preset-react":"^7.22.15","@commitlint/cli":"^17.7.1","@commitlint/config-conventional":"^17.7.0","@nx/cypress":"17.0.2","@nx/devkit":"17.0.2","@nx/eslint":"17.0.2","@nx/eslint-plugin":"17.0.2","@nx/jest":"17.0.2","@nx/js":"17.0.2","@nx/plugin":"17.0.2","@nx/react":"17.0.2","@nx/vite":"17.0.2","@nx/workspace":"17.0.2","@stackblitz/sdk":"^1.9.0","@swc-node/register":"1.6.8","@swc/cli":"~0.1.62","@swc/core":"1.3.95","@swc/helpers":"0.5.3","@testing-library/react":"14.0.0","@types/fs-extra":"^11.0.1","@types/lodash":"^4.14.198","@types/node":"18.14.2","@types/react":"^19.0.0","@types/react-dom":"^19.0.0","@types/yaml-front-matter":"^4.1.0","@typescript-eslint/eslint-plugin":"5.62.0","@typescript-eslint/parser":"5.62.0","@vitejs/plugin-react":"~4.0.4","@vitest/coverage-c8":"~0.32.4","@vitest/ui":"~0.32.4",cypress:"^13.0.0",eslint:"8.46.0","eslint-config-prettier":"9.0.0","eslint-plugin-cypress":"2.14.0","eslint-plugin-import":"2.27.5","eslint-plugin-jsx-a11y":"6.7.1","eslint-plugin-markdown":"^3.0.1","eslint-plugin-prettier":"^5.0.0","eslint-plugin-react":"7.32.2","eslint-plugin-react-hooks":"4.6.0","eslint-plugin-react-refresh":"^0.4.3","fs-extra":"^11.1.1",husky:"^8.0.0",jsdom:"~22.1.0",lerna:"~8.0.2",nx:"17.0.2","postcss-html":"^1.5.0","postcss-markdown":"^1.2.0",prettier:"^3.0.3",rxjs:"^7.8.1","rxjs-for-await":"^1.0.0",sass:"^1.66.1","sort-package-json":"^2.5.1",stylelint:"^15.10.3","stylelint-config-recess-order":"^4.3.0","stylelint-config-recommended-scss":"^12.0.0","stylelint-config-standard":"^34.0.0","stylelint-scss":"^5.1.0",surge:"^0.23.1","ts-node":"^10.9.1",typescript:"~5.1.3",verdaccio:"^5.0.4",vite:"~4.3.9","vite-plugin-svgr":"^4.2.0","vite-tsconfig-paths":"~4.2.1",vitest:"~0.32.4","yaml-front-matter":"^4.1.1"},xt={node:"16.x || 18.x || 20.x || 22.x",npm:"Please use pnpm instead of NPM to install dependencies",pnpm:"9.x"},vt={patchedDependencies:{"@nx/js@17.0.2":"patches/@nx__js@17.0.2.patch"}},_t={includedScripts:[]},S={name:ut,version:mt,private:!0,license:ht,scripts:bt,dependencies:ft,devDependencies:gt,engines:xt,pnpm:vt,nx:_t};function Se(e){return`{
  "name": "${e}",
  "version": "0.0.0",
  "private": true,
  "main": "src/index.tsx",
  "dependencies": {
    ...
    "bootstrap": "${S.dependencies.bootstrap}",
    "dayjs": "${S.dependencies.dayjs}",
    "immer": "${S.dependencies.immer}",
    "react": "${S.dependencies.react}",
    "react-dom": "${S.dependencies["react-dom"]}",
    "tslib": "${S.dependencies.tslib}"
  },
  "devDependencies": {
...
`}function yt(e,t,s){const i={"index.html":{content:v["index.html"]},"src/App.tsx":{content:v["src/App.tsx"]},"src/Demo.tsx":{content:t},"src/main.tsx":{content:v["src/main.tsx"]},"src/styles/index.scss":{content:v["src/styles/index.scss"]},"src/styles/vendor/bootstrap.scss":{content:v["src/styles/vendor/bootstrap.scss"]},"src/styles/vendor/laser-ui.scss":{content:v["src/styles/vendor/laser-ui.scss"]},"package.json":{content:Se(e)},"tsconfig.json":{content:v["tsconfig.json"]},"vite.config.ts":{content:v["vite.config.ts"]},".codesandbox/tasks.json":{content:ct}};s&&(i["src/styles/index.scss"]={content:`${v["src/styles/index.scss"]}
${s}`});const o=Ke({files:i}),c=document.createElement("form");c.method="POST",c.action="https://codesandbox.io/api/v1/sandboxes/define",c.target="_blank";const p=document.createElement("input");p.name="parameters",p.value=o;const m=document.createElement("input");m.name="query",m.value="module=/src/Demo.tsx";const a=document.createElement("input");a.name="environment",a.value="server",c.appendChild(p),c.appendChild(m),c.appendChild(a),document.body.append(c),c.submit(),document.body.removeChild(c)}const wt=500,jt=20,St=300,Et="https://stackblitz.com",xe=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],Ct=["project","search","ports","settings"],$t=["light","dark"],kt=["editor","preview"],ve={clickToLoad:e=>N("ctl",e),devToolsHeight:e=>_e("devtoolsheight",e),forceEmbedLayout:e=>N("embed",e),hideDevTools:e=>N("hidedevtools",e),hideExplorer:e=>N("hideExplorer",e),hideNavigation:e=>N("hideNavigation",e),openFile:e=>Q("file",e),showSidebar:e=>It("showSidebar",e),sidebarView:e=>re("sidebarView",e,Ct),startScript:e=>Q("startScript",e),terminalHeight:e=>_e("terminalHeight",e),theme:e=>re("theme",e,$t),view:e=>re("view",e,kt),zenMode:e=>N("zenMode",e),organization:e=>`${Q("orgName",e==null?void 0:e.name)}&${Q("orgProvider",e==null?void 0:e.provider)}`,crossOriginIsolated:e=>N("corp",e)};function Ee(e={}){const t=Object.entries(e).map(([s,i])=>i!=null&&ve.hasOwnProperty(s)?ve[s](i):"").filter(Boolean);return t.length?`?${t.join("&")}`:""}function N(e,t){return t===!0?`${e}=1`:""}function It(e,t){return typeof t=="boolean"?`${e}=${t?"1":"0"}`:""}function _e(e,t){if(typeof t=="number"&&!Number.isNaN(t)){const s=Math.min(100,Math.max(0,t));return`${e}=${encodeURIComponent(Math.round(s))}`}return""}function re(e,t="",s=[]){return s.includes(t)?`${e}=${encodeURIComponent(t)}`:""}function Q(e,t){return(Array.isArray(t)?t:[t]).filter(i=>typeof i=="string"&&i.trim()!=="").map(i=>`${e}=${encodeURIComponent(i)}`).join("&")}function Ce(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function ce(e,t){return`${$e(t)}${e}${Ee(t)}`}function ae(e,t){const s={forceEmbedLayout:!0};return t&&typeof t=="object"&&Object.assign(s,t),`${$e(s)}${e}${Ee(s)}`}function $e(e={}){return(typeof e.origin=="string"?e.origin:Et).replace(/\/$/,"")}function le(e,t,s){if(!t||!e||!e.parentNode)throw new Error("Invalid Element");e.id&&(t.id=e.id),e.className&&(t.className=e.className),Lt(t,s),Tt(e,t,s),e.replaceWith(t)}function de(e){if(typeof e=="string"){const t=document.getElementById(e);if(!t)throw new Error(`Could not find element with id '${e}'`);return t}else if(e instanceof HTMLElement)return e;throw new Error(`Invalid element: ${e}`)}function pe(e){return e&&e.newWindow===!1?"_self":"_blank"}function Lt(e,t={}){const s=Object.hasOwnProperty.call(t,"height")?`${t.height}`:`${St}`,i=Object.hasOwnProperty.call(t,"width")?`${t.width}`:void 0;e.setAttribute("height",s),i?e.setAttribute("width",i):e.setAttribute("style","width:100%;")}function Tt(e,t,s={}){var o,c;const i=((c=(o=e.allow)==null?void 0:o.split(";"))==null?void 0:c.map(p=>p.trim()))??[];s.crossOriginIsolated&&!i.includes("cross-origin-isolated")&&i.push("cross-origin-isolated"),i.length>0&&(t.allow=i.join("; "))}class Dt{constructor(t){this.pending={},this.port=t,this.port.onmessage=this.messageListener.bind(this)}request({type:t,payload:s}){return new Promise((i,o)=>{const c=Ce();this.pending[c]={resolve:i,reject:o},this.port.postMessage({type:t,payload:{...s,__reqid:c}})})}messageListener(t){var m;if(typeof((m=t.data.payload)==null?void 0:m.__reqid)!="string")return;const{type:s,payload:i}=t.data,{__reqid:o,__success:c,__error:p}=i;this.pending[o]&&(c?this.pending[o].resolve(this.cleanResult(i)):this.pending[o].reject(p?`${s}: ${p}`:s),delete this.pending[o])}cleanResult(t){const s={...t};return delete s.__reqid,delete s.__success,delete s.__error,Object.keys(s).length?s:null}}class Mt{constructor(t,s){this.editor={openFile:i=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:i}}),setCurrentFile:i=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:i}}),setTheme:i=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:i}}),setView:i=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:i}}),showSidebar:(i=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:i}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(i=>(i==null?void 0:i.url)??null),setUrl:(i="/")=>{if(typeof i!="string"||!i.startsWith("/"))throw new Error(`Invalid argument: expected a path starting with '/', got '${i}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:i}})}},this._rdc=new Dt(t),Object.defineProperty(this.preview,"origin",{value:typeof s.previewOrigin=="string"?s.previewOrigin:null,writable:!1})}applyFsDiff(t){const s=i=>i!==null&&typeof i=="object";if(!s(t)||!s(t.create))throw new Error("Invalid diff object: expected diff.create to be an object.");if(!Array.isArray(t.destroy))throw new Error("Invalid diff object: expected diff.destroy to be an array.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:t})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}}const ee=[];class At{constructor(t){this.id=Ce(),this.element=t,this.pending=new Promise((s,i)=>{const o=({data:u,ports:h})=>{(u==null?void 0:u.action)==="SDK_INIT_SUCCESS"&&u.id===this.id&&(this.vm=new Mt(h[0],u.payload),s(this.vm),p())},c=()=>{var u;(u=this.element.contentWindow)==null||u.postMessage({action:"SDK_INIT",id:this.id},"*")};function p(){window.clearInterval(a),window.removeEventListener("message",o)}window.addEventListener("message",o),c();let m=0;const a=window.setInterval(()=>{if(this.vm){p();return}if(m>=jt){p(),i("Timeout: Unable to establish a connection with the StackBlitz VM"),ee.forEach((u,h)=>{u.id===this.id&&ee.splice(h,1)});return}m++,c()},wt)}),ee.push(this)}}const Pt=e=>{const t=e instanceof Element?"element":"id";return ee.find(s=>s[t]===e)??null};function Rt(e,t){const s=document.createElement("input");return s.type="hidden",s.name=e,s.value=t,s}function zt(e){return e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}function ke({template:e,title:t,description:s,dependencies:i,files:o,settings:c}){if(!xe.includes(e)){const u=xe.map(h=>`'${h}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${u}`)}const p=[],m=(u,h,C="")=>{p.push(Rt(u,typeof h=="string"?h:C))};m("project[title]",t),typeof s=="string"&&s.length>0&&m("project[description]",s),m("project[template]",e,"javascript"),i&&(e==="node"?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):m("project[dependencies]",JSON.stringify(i))),c&&m("project[settings]",JSON.stringify(c)),Object.entries(o).forEach(([u,h])=>{m(`project[files][${zt(u)}]`,h)});const a=document.createElement("form");return a.method="POST",a.setAttribute("style","display:none!important;"),a.append(...p),a}function Nt(e,t){const s=ke(e);return s.action=ae("/run",t),s.id="sb_run",`<!doctype html>
<html>
...
</html>`}function Ht(e,t){const s=ke(e);s.action=ce("/run",t),s.target=pe(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function te(e){return e!=null&&e.contentWindow?(Pt(e)??new At(e)).pending:Promise.reject("Provided element is not an iframe.")}function Ot(e,t){Ht(e,t)}function Ut(e,t){const s=ce(`/edit/${e}`,t),i=pe(t);window.open(s,i)}function Bt(e,t){const s=ce(`/github/${e}`,t),i=pe(t);window.open(s,i)}function Wt(e,t,s){var p;const i=de(e),o=Nt(t,s),c=document.createElement("iframe");return le(i,c,s),(p=c.contentDocument)==null||p.write(o),te(c)}function Vt(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ae(`/edit/${t}`,s),le(i,o,s),te(o)}function Ft(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ae(`/github/${t}`,s),le(i,o,s),te(o)}const qt={connect:te,embedGithubProject:Ft,embedProject:Wt,embedProjectId:Vt,openGithubProject:Bt,openProject:Ot,openProjectId:Ut};function Kt(e,t,s){const i={"index.html":v["index.html"],"src/App.tsx":v["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":v["src/main.tsx"],"src/styles/index.scss":v["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":v["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/laser-ui.scss":v["src/styles/vendor/laser-ui.scss"],"package.json":Se(e),"tsconfig.json":v["tsconfig.json"],"vite.config.ts":v["vite.config.ts"]};s&&(i["src/styles/index.scss"]=`${v["src/styles/index.scss"]}
${s}`),qt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:i},{openFile:"Demo.tsx"})}function es(e){const{id:t,renderer:s,title:i,description:o,tsxSource:c,scssSource:p}=e,m=F(q(o)),a=q(c),u=p?q(p):void 0,{t:h}=ye(),C=d.useRef(null),A=F(String.raw`
${"```tsx"}
${a}
${"```"}
`),T=u?F(String.raw`
