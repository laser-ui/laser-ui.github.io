...
</html>`}function Ot(e,t){const s=ke(e);s.action=ae("/run",t),s.target=pe(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function te(e){return e!=null&&e.contentWindow?(Pt(e)??new Mt(e)).pending:Promise.reject("Provided element is not an iframe.")}function Ht(e,t){Ot(e,t)}function Ut(e,t){const s=ae(`/edit/${e}`,t),i=pe(t);window.open(s,i)}function Bt(e,t){const s=ae(`/github/${e}`,t),i=pe(t);window.open(s,i)}function Ft(e,t,s){var p;const i=de(e),o=Nt(t,s),a=document.createElement("iframe");return le(i,a,s),(p=a.contentDocument)==null||p.write(o),te(a)}function Vt(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/edit/${t}`,s),le(i,o,s),te(o)}function Wt(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/github/${t}`,s),le(i,o,s),te(o)}const qt={connect:te,embedGithubProject:Wt,embedProject:Ft,embedProjectId:Vt,openGithubProject:Bt,openProject:Ht,openProjectId:Ut};function Kt(e,t,s){const i={"index.html":v["index.html"],"src/App.tsx":v["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":v["src/main.tsx"],"src/styles/index.scss":v["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":v["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/laser-ui.scss":v["src/styles/vendor/laser-ui.scss"],"package.json":Se(e),"tsconfig.json":v["tsconfig.json"],"vite.config.ts":v["vite.config.ts"]};s&&(i["src/styles/index.scss"]=`${v["src/styles/index.scss"]}
