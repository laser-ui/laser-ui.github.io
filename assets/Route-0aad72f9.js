...
${s}`),qt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:i},{openFile:"Demo.tsx"})}function es(e){const{id:t,renderer:s,title:i,description:o,tsxSource:a,scssSource:p}=e,m=W(q(o)),c=q(a),u=p?q(p):void 0,{t:h}=ye(),$=d.useRef(null),A=W(String.raw`
${"```tsx"}
${c}
${"```"}
`),T=u?W(String.raw`
