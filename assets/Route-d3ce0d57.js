...
${s}`});const i=Ve({files:o}),r=document.createElement("form");r.method="POST",r.action="https://codesandbox.io/api/v1/sandboxes/define",r.target="_blank";const m=document.createElement("input");m.name="parameters",m.value=i;const p=document.createElement("input");p.name="query",p.value="module=/src/Demo.tsx",r.appendChild(m),r.appendChild(p),document.body.append(r),r.submit(),document.body.removeChild(r)}const _t=500,yt=20,wt=300,jt="https://stackblitz.com",fe=["angular-cli","create-react-app","html","javascript","node","polymer","typescript","vue"],St=["project","search","ports","settings"],Et=["light","dark"],Ct=["editor","preview"],ge={clickToLoad:e=>z("ctl",e),devToolsHeight:e=>xe("devtoolsheight",e),forceEmbedLayout:e=>z("embed",e),hideDevTools:e=>z("hidedevtools",e),hideExplorer:e=>z("hideExplorer",e),hideNavigation:e=>z("hideNavigation",e),openFile:e=>ve("file",e),showSidebar:e=>$t("showSidebar",e),sidebarView:e=>oe("sidebarView",e,St),startScript:e=>ve("startScript",e),terminalHeight:e=>xe("terminalHeight",e),theme:e=>oe("theme",e,Et),view:e=>oe("view",e,Ct),zenMode:e=>z("zenMode",e)};function Se(e={}){const t=Object.entries(e).map(([s,o])=>o!=null&&ge.hasOwnProperty(s)?ge[s](o):"").filter(Boolean);return t.length?`?${t.join("&")}`:""}function z(e,t){return t===!0?`${e}=1`:""}function $t(e,t){return typeof t=="boolean"?`${e}=${t?"1":"0"}`:""}function xe(e,t){if(typeof t=="number"&&!Number.isNaN(t)){const s=Math.min(100,Math.max(0,t));return`${e}=${encodeURIComponent(Math.round(s))}`}return""}function oe(e,t="",s=[]){return s.includes(t)?`${e}=${encodeURIComponent(t)}`:""}function ve(e,t){return(Array.isArray(t)?t:[t]).filter(o=>typeof o=="string"&&o.trim()!=="").map(o=>`${e}=${encodeURIComponent(o)}`).join("&")}function Ee(){return Math.random().toString(36).slice(2,6)+Math.random().toString(36).slice(2,6)}function ie(e,t){return`${Ce(t)}${e}${Se(t)}`}function re(e,t){const s={forceEmbedLayout:!0};return t&&typeof t=="object"&&Object.assign(s,t),`${Ce(s)}${e}${Se(s)}`}function Ce(e={}){return(typeof e.origin=="string"?e.origin:jt).replace(/\/$/,"")}function ae(e,t,s){if(!t||!e||!e.parentNode)throw new Error("Invalid Element");e.id&&(t.id=e.id),e.className&&(t.className=e.className),kt(t,s),e.replaceWith(t)}function ce(e){if(typeof e=="string"){const t=document.getElementById(e);if(!t)throw new Error(`Could not find element with id '${e}'`);return t}else if(e instanceof HTMLElement)return e;throw new Error(`Invalid element: ${e}`)}function le(e){return e&&e.newWindow===!1?"_self":"_blank"}function kt(e,t={}){const s=Object.hasOwnProperty.call(t,"height")?`${t.height}`:`${wt}`,o=Object.hasOwnProperty.call(t,"width")?`${t.width}`:void 0;e.setAttribute("height",s),o?e.setAttribute("width",o):e.setAttribute("style","width:100%;")}class It{constructor(t){this.pending={},this.port=t,this.port.onmessage=this.messageListener.bind(this)}request({type:t,payload:s}){return new Promise((o,i)=>{const r=Ee();this.pending[r]={resolve:o,reject:i},this.port.postMessage({type:t,payload:{...s,__reqid:r}})})}messageListener(t){var p;if(typeof((p=t.data.payload)==null?void 0:p.__reqid)!="string")return;const{type:s,payload:o}=t.data,{__reqid:i,__success:r,__error:m}=o;this.pending[i]&&(r?this.pending[i].resolve(this.cleanResult(o)):this.pending[i].reject(m?`${s}: ${m}`:s),delete this.pending[i])}cleanResult(t){const s={...t};return delete s.__reqid,delete s.__success,delete s.__error,Object.keys(s).length?s:null}}class Tt{constructor(t,s){this.editor={openFile:o=>this._rdc.request({type:"SDK_OPEN_FILE",payload:{path:o}}),setCurrentFile:o=>this._rdc.request({type:"SDK_SET_CURRENT_FILE",payload:{path:o}}),setTheme:o=>this._rdc.request({type:"SDK_SET_UI_THEME",payload:{theme:o}}),setView:o=>this._rdc.request({type:"SDK_SET_UI_VIEW",payload:{view:o}}),showSidebar:(o=!0)=>this._rdc.request({type:"SDK_TOGGLE_SIDEBAR",payload:{visible:o}})},this.preview={origin:"",getUrl:()=>this._rdc.request({type:"SDK_GET_PREVIEW_URL",payload:{}}).then(o=>(o==null?void 0:o.url)??null),setUrl:(o="/")=>{if(typeof o!="string"||!o.startsWith("/"))throw new Error(`Invalid argument: expected a path starting with '/', got '${o}'`);return this._rdc.request({type:"SDK_SET_PREVIEW_URL",payload:{path:o}})}},this._rdc=new It(t),Object.defineProperty(this.preview,"origin",{value:typeof s.previewOrigin=="string"?s.previewOrigin:null,writable:!1})}applyFsDiff(t){const s=o=>o!==null&&typeof o=="object";if(!s(t)||!s(t.create))throw new Error("Invalid diff object: expected diff.create to be an object.");if(!Array.isArray(t.destroy))throw new Error("Invalid diff object: expected diff.destroy to be an array.");return this._rdc.request({type:"SDK_APPLY_FS_DIFF",payload:t})}getDependencies(){return this._rdc.request({type:"SDK_GET_DEPS_SNAPSHOT",payload:{}})}getFsSnapshot(){return this._rdc.request({type:"SDK_GET_FS_SNAPSHOT",payload:{}})}}const X=[];class Dt{constructor(t){this.id=Ee(),this.element=t,this.pending=new Promise((s,o)=>{const i=({data:d,ports:u})=>{(d==null?void 0:d.action)==="SDK_INIT_SUCCESS"&&d.id===this.id&&(this.vm=new Tt(u[0],d.payload),s(this.vm),m())},r=()=>{var d;(d=this.element.contentWindow)==null||d.postMessage({action:"SDK_INIT",id:this.id},"*")};function m(){window.clearInterval(l),window.removeEventListener("message",i)}window.addEventListener("message",i),r();let p=0;const l=window.setInterval(()=>{if(this.vm){m();return}if(p>=yt){m(),o("Timeout: Unable to establish a connection with the StackBlitz VM"),X.forEach((d,u)=>{d.id===this.id&&X.splice(u,1)});return}p++,r()},_t)}),X.push(this)}}const Lt=e=>{const t=e instanceof Element?"element":"id";return X.find(s=>s[t]===e)??null};function Pt(e,t){const s=document.createElement("input");return s.type="hidden",s.name=e,s.value=t,s}function Mt(e){return e.replace(/\[/g,"%5B").replace(/\]/g,"%5D")}function $e({template:e,title:t,description:s,dependencies:o,files:i,settings:r}){if(!fe.includes(e)){const d=fe.map(u=>`'${u}'`).join(", ");console.warn(`Unsupported project.template: must be one of ${d}`)}const m=[],p=(d,u,C="")=>{m.push(Pt(d,typeof u=="string"?u:C))};p("project[title]",t),typeof s=="string"&&s.length>0&&p("project[description]",s),p("project[template]",e,"javascript"),o&&(e==="node"?console.warn("Invalid project.dependencies: dependencies must be provided as a 'package.json' file when using the 'node' template."):p("project[dependencies]",JSON.stringify(o))),r&&p("project[settings]",JSON.stringify(r)),Object.entries(i).forEach(([d,u])=>{p(`project[files][${Mt(d)}]`,u)});const l=document.createElement("form");return l.method="POST",l.setAttribute("style","display:none!important;"),l.append(...m),l}function Rt(e,t){const s=$e(e);return s.action=re("/run",t),s.id="sb_run",`<!doctype html>
<html>
...
</html>`}function At(e,t){const s=$e(e);s.action=ie("/run",t),s.target=le(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function Q(e){return e!=null&&e.contentWindow?(Lt(e)??new Dt(e)).pending:Promise.reject("Provided element is not an iframe.")}function Nt(e,t){At(e,t)}function zt(e,t){const s=ie(`/edit/${e}`,t),o=le(t);window.open(s,o)}function Ht(e,t){const s=ie(`/github/${e}`,t),o=le(t);window.open(s,o)}function Ot(e,t,s){var m;const o=ce(e),i=Rt(t,s),r=document.createElement("iframe");return ae(o,r,s),(m=r.contentDocument)==null||m.write(i),Q(r)}function Ut(e,t,s){const o=ce(e),i=document.createElement("iframe");return i.src=re(`/edit/${t}`,s),ae(o,i,s),Q(i)}function Bt(e,t,s){const o=ce(e),i=document.createElement("iframe");return i.src=re(`/github/${t}`,s),ae(o,i,s),Q(i)}const Wt={connect:Q,embedGithubProject:Bt,embedProject:Ot,embedProjectId:Ut,openGithubProject:Ht,openProject:Nt,openProjectId:zt};function Vt(e,t,s){const o={"index.html":x["index.html"],"src/App.tsx":x["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":x["src/main.tsx"],"src/styles/index.scss":x["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":x["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/laser-ui.scss":x["src/styles/vendor/laser-ui.scss"],"package.json":je(e),"tsconfig.json":x["tsconfig.json"],"vite.config.ts":x["vite.config.ts"]};s&&(o["src/styles/index.scss"]=`${x["src/styles/index.scss"]}
${s}`),Wt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:o},{openFile:"Demo.tsx"})}function Xt(e){const{id:t,renderer:s,title:o,description:i,tsxSource:r,scssSource:m}=e,p=V(F(i)),l=F(r),d=m?F(m):void 0,{t:u}=_e(),C=c.useRef(null),D=V(String.raw`
${"```tsx"}
${l}
${"```"}
`),I=d?V(String.raw`
