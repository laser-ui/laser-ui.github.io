...
</html>`}function Ht(e,t){const s=ke(e);s.action=ae("/run",t),s.target=pe(t),document.body.appendChild(s),s.submit(),document.body.removeChild(s)}function te(e){return e!=null&&e.contentWindow?(Pt(e)??new At(e)).pending:Promise.reject("Provided element is not an iframe.")}function Ot(e,t){Ht(e,t)}function Ut(e,t){const s=ae(`/edit/${e}`,t),i=pe(t);window.open(s,i)}function Bt(e,t){const s=ae(`/github/${e}`,t),i=pe(t);window.open(s,i)}function Vt(e,t,s){var p;const i=de(e),o=Nt(t,s),a=document.createElement("iframe");return le(i,a,s),(p=a.contentDocument)==null||p.write(o),te(a)}function Ft(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/edit/${t}`,s),le(i,o,s),te(o)}function Wt(e,t,s){const i=de(e),o=document.createElement("iframe");return o.src=ce(`/github/${t}`,s),le(i,o,s),te(o)}const qt={connect:te,embedGithubProject:Wt,embedProject:Vt,embedProjectId:Ft,openGithubProject:Bt,openProject:Ot,openProjectId:Ut};function Kt(e,t,s){const i={"index.html":v["index.html"],"src/App.tsx":v["src/App.tsx"],"src/Demo.tsx":t,"src/main.tsx":v["src/main.tsx"],"src/styles/index.scss":v["src/styles/index.scss"],"src/styles/vendor/bootstrap.scss":v["src/styles/vendor/bootstrap.scss"],"src/styles/vendor/laser-ui.scss":v["src/styles/vendor/laser-ui.scss"],"package.json":Se(e),"tsconfig.json":v["tsconfig.json"],"vite.config.ts":v["vite.config.ts"]};s&&(i["src/styles/index.scss"]=`${v["src/styles/index.scss"]}
${s}`),qt.openProject({title:e,description:"Demo of Laser UI",template:"node",files:i},{openFile:"Demo.tsx"})}function es(e){const{id:t,renderer:s,title:i,description:o,tsxSource:a,scssSource:p}=e,m=W(q(o)),c=q(a),u=p?q(p):void 0,{t:h}=ye(),C=d.useRef(null),A=W(String.raw`
${"```tsx"}
${c}
${"```"}
`),T=u?W(String.raw`
