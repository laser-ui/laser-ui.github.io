...
${s}`),Ut.openProject({title:e,description:"Demo of Laser UI",template:"node",files:o},{openFile:"Demo.tsx"})}function Jt(e){const{id:t,renderer:s,title:o,description:i,tsxSource:r,scssSource:m}=e,p=V(F(i)),l=F(r),d=m?F(m):void 0,{t:u}=_e(),C=c.useRef(null),T=V(String.raw`
${"```tsx"}
${l}
${"```"}
`),I=d?V(String.raw`
